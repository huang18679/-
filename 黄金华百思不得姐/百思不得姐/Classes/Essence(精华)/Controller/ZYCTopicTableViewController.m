...
//
//
#import "ZYCTopicTableViewController.h"
...
@interface ZYCTopicTableViewController ()
...
@implementation ZYCTopicTableViewController
...
- (NSString *)aparam
{
    if (self.parentViewController.class == [ZYCNewViewController class]) {
        return @"newlist";
    }
    return @"list";
}
...
{
    return self.topices[indexPath.row].cellHeight;
    
}

- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ZYCCommentViewController *comment = [[ZYCCommentViewController alloc] init];
    comment.topic = self.topices[indexPath.row];
...
{
    NSString *video2 = [self.topices valueForKey:@"videouri"];
    video2 = nil;
